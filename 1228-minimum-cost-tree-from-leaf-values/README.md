<h2><a href="https://leetcode.com/problems/minimum-cost-tree-from-leaf-values">Minimum Cost Tree From Leaf Values</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Given an array <code>arr</code> of positive integers, consider all binary trees such that:</p>
